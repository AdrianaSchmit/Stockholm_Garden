"""
Django settings for stockholm_garden project.
...
ROOT_URLCONF = 'stockholm_garden.urls'
...
if 'USE_AWS' in os.environ:
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'gardenstockholm'
...
if 'DEVELOPMENT' in os.environ:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'stockholmgarden@example.com'
else:
